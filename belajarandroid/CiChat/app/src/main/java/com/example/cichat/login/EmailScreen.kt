...
import com.example.cichat.MainActivity
...
@Composable
fun EmailRegisterScreen(viewModel: LoginViewModel) {
    Column(
        modifier = Modifier
            .verticalScroll(rememberScrollState())
            .padding(start = 24.dp, top = 24.dp, end = 24.dp, bottom = 24.dp)
        ...
        ConfirmRegisterPasswordField(viewModel)
//        ButtonEmailPasswordLogin(viewModel)
        ButtonEmailPasswordCreate(viewModel)
    }
}
...
@Composable
fun RegisterEmailField(viewModel: LoginViewModel) {
    val userEmail = viewModel.userEmail.value
...
@Composable
fun RegisterPasswordField(viewModel: LoginViewModel) {
    val password = viewModel.password.value
...
@Composable
fun ConfirmRegisterPasswordField(viewModel: LoginViewModel) {
